    ...
    <div class="card text-center" style="min-height: 70vh;">
        <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs">
                <li class="nav-item">
                    <a class="nav-link <?= $action == 'connection' ? 'active' : 'colorlink' ?>" aria-current="true" href="login.php?action=connection">Connexion</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= $action == 'subscribe' ? 'active' : 'colorlink' ?>" href="login.php?action=subscribe">Inscription</a>
                </li>
            </ul>
        </div>
        <div class="card-body">
