...
<head>
    ...
    <link rel="canonical" href="http://www.ecommerce.net/<?= $_SERVER['PHP_SELF'] == '/views/product.php' ? 'product/'.$product['id'].'/'.$product['slug'] : '' ?>">
    ...
    <script defer src="../../assets/js/addToCart.js"></script>
</head>
