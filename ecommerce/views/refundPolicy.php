<?php
require_once '../controllers/ctrRefundPolicy.php';
...
<div class="container mt-3 text-bluedark">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb colorlink">
            ...
            <li class="breadcrumb-item active">Politique de Retour et de Remboursement</li>
        </ol>
    </nav>
    ...
    <div class="card text-center" style="min-height: 70vh;">
        ...
        <div class="card-body">
            ...
            <div class="row justify-content-center p-lg-3 p-1">
                <h1 class="mb-5">Politique de Retour et de Remboursement</h1>
